...
import { TreeSitterPlugin, builtinLanguageConfigs } from '../../../packages/core/dist/index.js';
import { compareFileSymbols } from '../../../skills/understand/validate-incremental-symbols.mjs';
