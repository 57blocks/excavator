...
describe('skill command hardening', () => {
  ...
  it('quotes skill and target directory placeholders in knowledge commands', () => {
    const content = readRepoFile('skills/understand-knowledge/SKILL.md');
  ...
  it('quotes dashboard cd targets and GRAPH_DIR assignment', () => {
    const content = readRepoFile('skills/understand-dashboard/SKILL.md');
  ...
  it('marks project-controlled context as untrusted data', () => {
    const understand = readRepoFile('skills/understand/SKILL.md');
    const knowledge = readRepoFile('skills/understand-knowledge/SKILL.md');
