...
- [ ] 2.5 Coder updates Chat to preserve the original question, add English retrieval expressions, and choose answer language after source verification; verify Chinese, English, explicit-Japanese, and identifier-only fixtures return the required language without changing config or semantic storage language.
