...
- [x] 2.2 Coder updates `skills/excavator-chat/SKILL.md` with the ordered intent contract; verify the frozen publish-field question selects local/source-first, the editor-to-database question selects bounded segmented flow, an explicit A→B question selects shortest path, and direct-caller questions select 1-hop.
