...
1. Write the JSON array to `$DATA_DIR/intermediate/tour.json` inside the project's data directory (`.excavator/`). Use the exact output path given in your dispatch prompt if one was provided.
